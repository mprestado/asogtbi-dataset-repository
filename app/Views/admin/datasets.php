...
<header class="portal-heading"><p class="eyebrow">Administrator Queue</p><h1>Dataset moderation</h1><p>Assign reviewers, inspect history, publish approved submissions, and manage archive state.</p></header>
